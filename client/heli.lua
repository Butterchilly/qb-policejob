...
local zoomspeed = 25.0 -- camera zoom speed
...
-- Functions
local function IsAuthHelicopter(vehicle)
	for _, model in pairs(Config.AuthorisedHeliCam) do
...
local function HandleZoom(cam)
	...
	SetCamFov(cam, current_fov + (fov - current_fov)*0.08) -- Smoothing of camera zoom
end
